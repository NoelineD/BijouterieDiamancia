<div>
    ...
    <figure class="introFigure">
        ...
        <figcaption class="introFigcaption">Nos Bagues</figcaption>
        <img class="introImg" src="/Autres/collierAigue52.jpg" alt="introImg" style="width:100%" img>
                ...
                <?php foreach ($rings as $ring) : ?>
                    <div class="card">
                        <figure>
                            ...
                            <img src="/App/Assets/<?= $ring->getImage_name(); ?>" alt="image article" />
                            <figcaption><?= $ring->getTitle(); ?></figcaption>
                        </figure>
                        <p> <?= $ring->getPrice(); ?> &euro;</p>
                        ...
                        <ul>
                            ...
                            <?php if ($_SESSION['role'] === 'CLIENT') : ?>
                                <li>
                                    ...
                                    <a href="index.php?entite=jewels&action=addtocart&id=<?= $ring->getId(); ?>">Ajouter</a>
                                </li>
                                <!-- a faire Admin -->
                                <!-- si l'utilisateur connecté est de rôle ADMIN -->
                                <li>
                                    <a href="index.php?entite=jewels&action=delete&id=<?= $ring->getId(); ?>">Retirer</a>
                                </li>
                            <?php endif ?>
                            ...
                            <?php if ($_SESSION['role'] === 'ADMIN') : ?>
                                ...
                                <li>
                                    <a href="index.php?entite=jewels&action=see&id=<?= $ring->getId(); ?>">modifier</a>
                                </li>
                            <?php endif ?>
