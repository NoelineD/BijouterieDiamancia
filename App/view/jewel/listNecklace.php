            ...
            <?php foreach ($necklaces as $necklace) : ?>
                <div class="card">
                    <figure>
                        ...
                        <img src="/App/Assets/<?= $necklace->getImage_name(); ?>" alt="image article" />
                        <figcaption><?= $necklace->getTitle(); ?></figcaption>
                    </figure>
                    <p> <?= $necklace->getPrice(); ?> &euro;</p>
                    ...
                    <ul>
                        ...
                        <?php if ($_SESSION['role'] === 'CLIENT') : ?>
                            <li>
                                ...
                                <a href="index.php?entite=jewels&action=addtocart&id=<?= $necklace->getId(); ?>">Ajouter</a>
                            </li>
                            <!-- a faire Admin -->
                            <!-- si l'utilisateur connecté est de rôle ADMIN -->
                            <li>
                                <a href="index.php?entite=jewels&action=delete&id=<?= $necklace->getId(); ?>">Retirer</a>
                            </li>
                        <?php endif ?>
                        ...
                        <?php if ($_SESSION['role'] === 'ADMIN') : ?>
                            ...
                            <li>
                                <a href="index.php?entite=jewels&action=see&id=<?= $necklace->getId(); ?>">modifier</a>
                            </li>
                        <?php endif ?>
