<div style="width:100%;">
  <!-- <h1>Bienvenue sur le site Diamancia</h1> -->

  <figure>

    <figcaption><cite>"L'âme du diamant est la lumière."</cite> <span>Hildegarde de Bingen</span></figcaption>
    <img class="introImg" src="/Autres/DiamondRing.jpg" alt="introImg" style="width:100%">
    <button class="btnImg" type="button">Decouvrez nos produits</button>
  ...
  <div class="presentation">
    <p class="fontStyle">La joaillerie est un art . L'exigence, la précision et la fabrication de produit de qualité est notre devoir.</p>
    <!-- <p>Nous faisons du bonheur de nos clients, notre priorité</p> -->
  </div>

  <div id="blocVideo">
    <video id="video" type="video/mp4" src="\Autres\fabrication.mp4" controls autoplay muted loop></video>
  </div>
